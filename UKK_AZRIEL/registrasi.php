    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                      <h5>login</h5>
                      <a href="log.php">jika sudah punya akun, silahkan klik link ini untuk login</a>
                    </div>
                  </div>
                  <div class="carousel-item" data-bs-interval="2000">
                    <img src="welcome2.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                      <h5>login</h5>
                  ...
                  <div class="carousel-item">
                    <img src="welcome3.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block" >
                      <h5>mohon untuk</h5>
          ...
          <div class="col">
            ...
            <div class="card shadow-lg" style="height: 500px; width: 500px; padding: 25px 50px 50px 50px; background-color: #FFB703;">
                <!-- input -->
            <h1 style="text-align: center; color: black;">Daftar dulu ya!</h1> <br> <br>
                  ...
                  <!-- button -->
                 <button class="btn btn-dark" style="color: #8ECAE6;">DAFTAR</button>
                <a href="log.php" style="text-align: center;">sudah punya akun? klik disini</a>
            </div>
            </div>
          </div>
        </div>
