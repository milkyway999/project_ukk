    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <div class="card shadow-lg" style="height: 500px; width: 500px; padding: 50px 50px 50px 50px; background-color: #FFB703;">
                <!-- input -->
            <h1 style="text-align: center; color: black;">login dulu ya!</h1> <br> <br>
                  ...
                  <!-- button -->
                 <button class="btn btn-dark" style="color: #8ECAE6;">LOGIN</button>
